...
export const driverSeasonData: DriverSeasonData[] = [
  // Max Verstappen
  {
    ...
    totalPoints: 249,
    races: [
      { raceId: "australia-2018", points: 15, position: 3 },
      { raceId: "bahrain-2018", points: 18, position: 2 },
      { raceId: "abu-dhabi-2018", points: 15, position: 3 },
    ],
  },
  {
    driverId: "verstappen",
    ...
    totalPoints: 278,
    races: [
      { raceId: "australia-2019", points: 12, position: 4 },
      { raceId: "bahrain-2019", points: 25, position: 1 },
      { raceId: "abu-dhabi-2019", points: 18, position: 2 },
    ],
  },
  {
    driverId: "verstappen",
  ...
  },
  {
    ...
    races: [
      ...
      { raceId: "saudi-arabia-2026", points: 18, position: 2 },
      { raceId: "abu-dhabi-2026", points: 25, position: 1 },
    ],
  },
